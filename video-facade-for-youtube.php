<?php
/**
 * Plugin Name: Facade for YouTube videos
 * Description: Show a facade/thumbnail for a YouTube Video and loads the YouTube video only on click.
 ...
 * Text Domain: youtube-video-facade
 */
