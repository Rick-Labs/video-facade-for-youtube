...
function yvf_shortcode($atts) {
    ...
    <div class="youtube-video-facade" data-id="<?php echo esc_attr($atts['id']); ?>">
        <!-- Intentionally using a direct <img> tag because the user supplies a media file URL -->
...
function enqueue_yvf_assets_for_specific_pages() {
    ...
    if (is_page($target_page_ids)) {
        ...
        wp_register_style('youtube-video-facade-style', false, [], '0.1.0 ');
        ...
        wp_register_script('youtube-video-facade', false, [], '0.1.0', true);
